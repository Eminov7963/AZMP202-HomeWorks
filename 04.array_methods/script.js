...
// let new_product = products.filter((element)=>{
//     return element.rating.rate > 3 
// })
// console.log(new_product);

// #total price'i tapın

// let new_product = products.reduce((sum,element)=>{
...
// let new_product = products.sort((a, b) => a.price - b.price);

// console.log(new_product);

// #title'a görə a'dan z'yə, və z'dən a'ya sort edin
// let new_product = products.sort((a, b) => {
...
// let new_product = products.every((p) =>(p.rating.count > 100));

// console.log(new_product);

// #category'si "electronics" olanların qiymətini 50% endirin
// let new_product = products.map((item) =>{
